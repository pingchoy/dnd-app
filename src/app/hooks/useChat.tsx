...
import { GameState, INITIAL_GAME_STATE, OPENING_NARRATIVE } from "../lib/gameState";
...
export function useChat(): UseChatReturn {
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: "assistant", content: OPENING_NARRATIVE, timestamp: Date.now() },
  ]);
  ...
  async function sendMessage(input: string): Promise<void> {
    if (!input.trim() || isRolling || isNarrating || pendingRoll) return;
